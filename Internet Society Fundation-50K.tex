...
La solución provee \textbf{comunicación digital autónoma} — mensajería, alertas y coordenadas GPS — sin internet, sin infraestructura corporativa y sin costos de mantenimiento recurrentes. No reemplaza a internet: lo complementa aprovechando los escasos puntos de acceso existentes en el territorio. Será gestionada y mantenida por mujeres rurales de cada paraje, garantizando la autonomía operativa de la red.
...
Meshtastic es un protocolo de comunicación de código abierto que opera sobre radiofrecuencia LoRa (\textit{Long Range}). \textbf{No es internet}: es una red de mensajería directa entre dispositivos que permite transmitir mensajes de texto, coordenadas GPS y alertas sin necesidad de internet, telefonía móvil ni infraestructura centralizada. Funciona de forma completamente autónoma y permanente, independientemente de si existe o no conectividad a internet en el área.
...
\textbf{Resiliencia ante emergencias.} La principal fortaleza de esta tecnología es que \textbf{no depende de ninguna infraestructura externa para funcionar}: si internet cae, si la telefonía móvil falla, si hay un corte de energía en la región, la red Meshtastic sigue operando de forma completamente autónoma gracias a sus nodos solares. Meshtastic fue concebida originalmente para contextos de emergencia, rescate y operaciones en terrenos de orografía compleja —exactamente las condiciones de la Quebrada de Humahuaca, donde los aludes, las crecidas de quebradas y el aislamiento climático son riesgos reales y recurrentes. En una situación de siniestro, esta red puede ser el único canal de comunicación disponible para coordinar evacuaciones, ubicar personas y solicitar asistencia, convirtiéndose en infraestructura crítica de seguridad comunitaria. El proyecto contempla la integración formal de los \textbf{Bomberos Voluntarios} y de \textbf{Defensa Civil} de la Quebrada de Humahuaca como usuarios institucionales de la red, dotándolos de terminales y protocolos de comunicación específicos para situaciones de emergencia. Esta integración multiplica el valor de la infraestructura: la misma red que conecta a una familia en el cerro con un turista en la ciudad puede activar una cadena de rescate coordinada entre parajes, bomberos y defensa civil en minutos.
...
\begin{itemize}
  ...
  \item Cuando existe un punto de internet en la zona (Starlink o wifi escolar), la red entera puede beneficiarse de ese acceso puntual a través del gateway MQTT, sin que cada hogar deba costear una conexión individual.
\end{itemize}

La configuración MQTT es parte del proceso de instalación y capacitación previsto en el plan de trabajo.

\subsection{Antecedentes de redes similares}

Red Yerba Buena no parte de cero. Meshtastic cuenta con una comunidad global activa y casos de uso documentados en contextos análogos al de la Quebrada de Humahuaca. En Argentina, la comunidad \textbf{Mesh Argentina} (mesharg.com.ar) nuclea a usuarios y técnicos que despliegan nodos en zonas rurales y de montaña sin cobertura celular, y es la referencia local para capacitación y soporte técnico. La regulación argentina es explícita: la \textbf{Resolución ENACOM 581/2018} habilita la banda AU915--928 MHz para uso libre, que es la banda que utiliza Meshtastic en el país.

A nivel internacional, el uso de redes Meshtastic en emergencias ha sido validado en eventos reales: durante los incendios de Los Ángeles de enero de 2025, redes Meshtastic comunitarias preexistentes proveyeron comunicación cuando las redes celulares colapsaron. El caso de \textbf{WiMesh} —red mesh desplegada en una aldea rural de montaña en Pakistán, documentada en literatura académica— demuestra la viabilidad técnica y social de este modelo en territorios con orografía compleja, baja densidad poblacional y ausencia de infraestructura, condiciones idénticas a las de la Quebrada de Humahuaca.
...
La tecnología LoRa opera en la banda de \textbf{915 MHz}, clasificada como banda ISM (\textit{Industrial, Scientific and Medical}) de uso libre en Argentina según las regulaciones de la \textbf{ENACOM} (Ente Nacional de Comunicaciones). Esta banda no requiere licencia de operación para potencias de transmisión en los rangos utilizados por Meshtastic (hasta 1W), lo que elimina barreras regulatorias para el despliegue de la red.

\subsection{Derechos de las comunidades indígenas}

El proyecto opera dentro del marco constitucional argentino que reconoce los derechos de los pueblos originarios (Art. 75 inc. 17, CN) y el \textbf{Convenio 169 de la OIT}, incorporado al ordenamiento jurídico nacional. El proceso de consulta libre, previa e informada en curso con cada asamblea comunitaria es el mecanismo de cumplimiento de este marco normativo. Los convenios firmados entre Fundación exACTa y cada comunidad formalizan los acuerdos de co-gestión y propiedad comunitaria de la infraestructura desplegada en cada paraje.

\subsection{Personería jurídica y gestión de fondos}

\textbf{Fundación exACTa} está debidamente constituida bajo la normativa argentina de fundaciones (Ley 19.836), con CUIT 30-70870222-2, y cuenta con experiencia acreditada en la gestión de fondos internacionales en colaboración con UCLA REMAP. Es la entidad responsable de la recepción, administración y rendición de los fondos del grant.

\subsection{Fondo de Servicio Universal}

Argentina cuenta con el \textbf{Fondo Fiduciario del Servicio Universal (FFSU)}, administrado por ENACOM, cuyo mandato es garantizar el acceso a las comunicaciones en zonas donde el mercado no provee cobertura —exactamente la situación de los parajes de la Quebrada de Humahuaca. En las Etapas 2 y 3 del proyecto se explorará la articulación con el FFSU como fuente de financiamiento complementario, consolidando el modelo de Red Yerba Buena dentro del marco de política pública de conectividad universal de Argentina.
...
Un principio central del proyecto es la \textbf{propiedad comunitaria de la infraestructura}: los nodos instalados en cada paraje son propiedad de la comunidad respectiva, no de Colectivo Nodo Norte ni de Fundación exACTa. Los convenios firmados con cada asamblea establecen explícitamente este punto. Las comunidades son simultáneamente usuarias, operadoras y dueñas de su red —exactamente el modelo de gobernanza que define a una red comunitaria genuina.

\textbf{Inclusión y mediación comunitaria.} Las mujeres referentes capacitadas en cada paraje no cumplen únicamente un rol técnico: son mediadoras entre la tecnología y el conjunto de la comunidad, atentas a las necesidades de adultos mayores, niños, personas con menor alfabetización digital y cualquier miembro que requiera acompañamiento para incorporarse al uso de la red. Su rol garantiza que la conectividad no beneficie solo a quienes ya tienen habilidades digitales, sino que alcance progresivamente a toda la comunidad.

\textbf{Solidaridad inter-paraje.} Una dimensión central y frecuentemente invisible del proyecto es que los siete parajes de la Quebrada están hoy \textit{incomunicados entre sí}: no existe ningún canal de comunicación directa entre comunidades vecinas que no implique desplazamiento físico. Red Yerba Buena crea por primera vez un tejido de comunicación horizontal entre parajes —no solo hacia afuera sino entre sí— habilitando formas de coordinación, ayuda mutua y solidaridad territorial que actualmente no son posibles. Un aviso de lluvia intensa en Tres Cruces puede llegar a Iturbe antes de que el agua baje; una familia en Negra Muerta puede comunicar una emergencia a sus vecinos de Chorrillos sin que nadie deba subir a un cerro o recorrer kilómetros.

Además de las comunidades indígenas, el proyecto incorpora como \textbf{actores institucionales} a los \textbf{Bomberos Voluntarios de Humahuaca} y a \textbf{Defensa Civil} del departamento, quienes participarán en el diseño de los protocolos de emergencia de la red y recibirán capacitación en el uso del sistema. Su involucramiento garantiza que la red funcione como infraestructura oficial de gestión de siniestros en el territorio, articulando la respuesta comunitaria con los organismos estatales de protección civil.
...
En el marco conceptual de redes comunitarias, Colectivo Nodo Norte opera como \textbf{organización meso}: articula el nivel \textit{micro} (las familias y comunidades usuarias y dueñas de la red) con el nivel \textit{macro} (Fundación exACTa/cheLA como entidad institucional, ENACOM como regulador, y UCLA REMAP como referente académico internacional). Esta posición meso es la que permite traducir las necesidades tecnológicas del territorio en proyectos viables, y conectar la experiencia comunitaria local con recursos y conocimientos globales.
...
Entre los proyectos más relevantes de la organización para este programa se destacan: \textbf{EduSol}, programa de educación con Software Libre para escuelas del barrio de Parque Patricios (donde se ubica cheLA), desarrollado por Patricia Vanesa Quiroz, que formó a docentes y estudiantes en herramientas digitales de acceso abierto. \textbf{sur@norte@sur}, programa de investigación financiado por Latin American Digital Cultures de UCLA, del que emergió la investigación de Fabian Wagmister en \textit{Computación Cívica Comunitaria} (\textit{Community Cultural Computing}), marco conceptual directo del presente proyecto. \textbf{Experiencia Iberá} (2016), primer proyecto en Argentina en usar una red de sensores audiovisuales para una instalación interactiva comunitaria, diseñada con UCLA REMAP y exhibida en Tecnópolis ante decenas de miles de visitantes. \textbf{Las Cuencas Cuentan} (2024--2026), residencia de investigación y creación en ambientes hídricos en territorio, con apoyo de Metabolic Studio y Fundación Williams.

\subsection{Responsable del proyecto}

\textbf{Patricia Vanesa Quiroz} es \textbf{Diseñadora de Imagen y Sonido} egresada de la Facultad de Arquitectura, Diseño y Urbanismo de la Universidad de Buenos Aires (FADU-UBA). Fue coordinadora de cheLA entre 2004 y 2007, período en que se consolidó la alianza institucional entre Fundación exACTa y UCLA REMAP, mediante proyectos de Computación Cultural Comunitaria. Durante ese período desarrolló \textbf{EduSol}, programa de educación con Software Libre para escuelas de Parque Patricios, e integró el equipo del programa de investigación \textbf{sur@norte@sur} (Latin American Digital Cultures, UCLA). Su formación en diseño y su trayectoria de 20 años en la intersección de tecnología comunitaria, cultura y territorio en América Latina son la base operativa de este proyecto.

\subsection{Asesor académico}

\textbf{Fabian Wagmister}, Profesor y Director del Departamento de Cine, Televisión y Medios Digitales de la Escuela de Teatro, Cine y Televisión de la \textbf{UCLA}, Director General de cheLA y fundador de \textbf{UCLA REMAP}, actúa como asesor estratégico del proyecto. Su investigación en \textit{Community Cultural Computing} y su colaboración activa con comunidades latinoamericanas durante más de dos décadas proveen el marco conceptual y académico de la iniciativa.
...
\begin{description}
  ...
  \item[Meses 10--12: Monitoreo, documentación y evaluación]
    Sistematización de aprendizajes e informe final para el financiador. Recolección y análisis de métricas de uso: número de mensajes enviados por paraje, frecuencia de uso por comunidad, incidentes de emergencia reportados, reservas y ventas generadas a través de la red. Evaluación participativa con las mujeres operadoras y referentes comunitarios sobre el impacto percibido. Identificación de mejoras técnicas y de protocolo para las Etapas 2 y 3. Preparación de la solicitud Scaling Track.
\end{description}
...
José Ruiz --- instalador en campo (24 fines de semana + viáticos)
  & Técnico local, Colectivo Nodo Norte & 8.640 \\
\midrule
...
\begin{itemize}
  ...
  \item Los honorarios de coordinación incluyen el diseño, gestión y hosting de proyectos productivos y turísticos comunitarios, la configuración del bridge WhatsApp--MQTT y la identidad digital de los emprendimientos. La coordinadora es Diseñadora de Imagen y Sonido (FADU-UBA), formación que sustenta directamente este componente. Este trabajo es inseparable de la infraestructura técnica: la red cobra valor cuando existe una oferta organizada y visualmente comunicada capaz de aprovecharla.
...
\begin{description}
  \item[Autonomía técnica] Los nodos Meshtastic son alimentados por energía solar, no requieren mantenimiento diario y operan indefinidamente sin costos recurrentes. La red funciona con total independencia de internet, telefonía móvil o energía de red: si cualquiera de estas infraestructuras falla —como ocurre frecuentemente en eventos climáticos extremos en los Andes— la red Meshtastic continúa operando. Las mujeres operadoras capacitadas pueden resolver las incidencias más comunes sin asistencia externa.
  ...
  \item[Monitoreo y mejora continua] La red Meshtastic genera datos de uso en tiempo real accesibles desde cualquier nodo con conexión a internet: volumen de mensajes, nodos activos, cobertura efectiva. Las mujeres operadoras registran incidencias y el equipo técnico realiza visitas de mantenimiento preventivo cada tres meses. Los datos de uso y las evaluaciones participativas alimentan el proceso de mejora continua y la planificación de las etapas siguientes.
...
\begin{itemize}
  ...
  \item \textbf{Infraestructura de emergencia activa}: red operativa cuando internet y telefonía fallan, habilitando coordinación de rescate y evacuaciones en territorio con riesgo de aludes e inundaciones
  \item \textbf{Bomberos Voluntarios y Defensa Civil} de Humahuaca integrados como usuarios institucionales con terminales propias y protocolos de emergencia co-diseñados con las comunidades
...
\begin{description}
  ...
  \item[Fabian Wagmister] Asesor estratégico. Profesor y Director del Departamento de Cine, Televisión y Medios Digitales, Escuela de Teatro, Cine y Televisión, UCLA. Director General de cheLA y fundador de UCLA REMAP. Investigador en \textit{Community Cultural Computing} y tecnología para el empoderamiento comunitario en América Latina.
  ...
  \item[José Ruiz] Coordinador Técnico del Colectivo Nodo Norte. Especialista en electricidad, instalación de paneles solares, bioconstrucción y permacultura. Guía de turismo. Reside en Tres Cruces, Quebrada de Humahuaca. Su combinación de saberes técnicos y conocimiento territorial profundo lo posiciona como el perfil idóneo para el despliegue de nodos solares en altura y para el acompañamiento de los emprendimientos turísticos que la red habilita.
\end{description}
