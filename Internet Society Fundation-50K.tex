...
Desde 2003 la UNESCO reconoce el valor patrimonial de este territorio. Sin embargo, las familias jóvenes se ven forzadas al éxodo urbano por falta de caminos, energía, transporte y conectividad. Este proyecto está planteado para iniciar un proceso de prosperidad progresiva para que los jóvenes tengan un lugar adonde volver, y para que formar una familia en el territorio sea un horizonte posible.

\subsection{Las comunidades beneficiarias}

El proyecto interviene en siete comunidades distribuidas desde el centro hacia el norte de la Quebrada de Humahuaca:
...
\begin{description}
  ...
  \item[Nodos fijos en altura] Equipos con carcasa de protección IP67, panel solar y batería (USD 90 c/u) instalados en puntos elevados de los cerros. Garantizan la cobertura y el alcance de la red entre parajes. Los nodos ubicados en puntos con acceso a internet (escuelas, parajes con Starlink) funcionan además como gateways MQTT.
   ...
   \item[Nodo Radio Municipal Humahuaca] El nodo principal de la ciudad de Humahuaca, estará en la antena de la radio municipal, permitiendo que los miembros de la Red Yerba Buena puedan dar aviso a la población de siniestros, festividades, sucesos climáticos, entre otras cuestiones de interés comunitario, en la radio principal del departamento.
...
La red será operada y mantenida por mujeres rurales de cada paraje. El diseño del sistema prioriza la simplicidad operativa: los nodos fijos son autónomos (panel solar, sin intervención diaria) y las terminales personales funcionan como cualquier dispositivo Bluetooth o por usb.
...
\textbf{Patricia Vanesa Quiroz} fue coordinadora de cheLA entre 2004 y 2007, período en que se consolidó la el funcionamiento institucional entre Fundación exACTa y UCLA REMAP, mediante proyectos de Computación Cultural Comunitaria. Su trayectoria de 20 años en la intersección de tecnología comunitaria, cultura y territorio en América Latina es la base operativa de este proyecto.
...
\begin{description}
  ...
  \item[Etapa 3 --- USD 100.000] Replicación del modelo en otras regiones andinas de Argentina y estudio para replicar en la región andina de países cercanos andinos, como Chile, Bolivia y Perú.
\end{description}
...
\begin{itemize}
  \item \textbf{500 personas} con acceso a comunicación digital en 7 parajes y comunidades previamente aisladas
...
\begin{description}
  \item[Patricia Vanesa Quiroz] Coordinadora del proyecto. Ex coordinadora de cheLA (2004--2007). 20 años de trayectoria en tecnología comunitaria y cultura en América Latina. Radicada en Tres Cruces, Quebrada de Humahuaca. Responsable del diseño, gestión y hosting de los proyectos productivos y turísticos familiares y comunitarios que la red habilita, incluyendo identidad digital, integración WhatsApp--MQTT y sistemas de comunicación con el exterior.
  ...
  \item[José María Ruiz] Coordinador Técnico del Colectivo Nodo Norte. Técnico con experiencia en trabajo en altura. Responsable del despliegue de nodos en campo.
\end{description}
